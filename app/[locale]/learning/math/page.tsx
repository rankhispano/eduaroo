...
import ExplorerPassWidget from '@/components/ExplorerPassWidget';
...
export default function MathSelectionPage() {
    ...
    const grades = [
        { id: 'grade1', active: true, href: '/learning/math/grade1' },
        { id: 'grade2', active: true, href: '/learning/math/grade2' },
        { id: 'grade3', active: true, href: '/learning/math/grade3' },
        { id: 'grade4', active: true, href: '/learning/math/grade4' },
        { id: 'grade5', active: true, href: '/learning/math/grade5' },
        { id: 'grade6', active: true, href: '/learning/math/grade6' },
    ];
