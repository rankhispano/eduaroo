  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-5 py-10">
      <section className="max-w-xl rounded-3xl bg-white p-8 text-center shadow-sm">
        <h1 className="text-3xl font-black text-slate-950">No se ha podido cargar la página</h1>
        <p className="mt-3 text-lg font-semibold text-slate-600">
          Reintenta la carga o vuelve al inicio para elegir de nuevo el curso.
        </p>
